...
~~~sh
# getting the code
git clone git@github.com:nko4/polar-badlands.git && cd ./polar-badlands/

# developing
npm install
npm start

# deploying (to http://polar-badlands.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@polar-badlands.2013.nodeknockout.com
ssh root@polar-badlands.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@polar-badlands.2013.nodeknockout.com
ssh -i ./id_deploy root@polar-badlands.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/polar-badlands" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
